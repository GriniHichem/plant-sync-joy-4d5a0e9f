-- SUJET : Réception F&L – Nettoyage indicateurs par période Qualité
-- On retire la durée moyenne des indicateurs par période car elle n'est plus demandée ici (uniquement en consultation).
-- La fonction get_reception_qualitative_kpis doit rester cohérente avec l'UI.
