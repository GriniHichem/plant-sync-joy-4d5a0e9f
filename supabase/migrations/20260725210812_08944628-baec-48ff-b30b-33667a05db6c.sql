...
BEGIN
  ...
  LOOP
    ...
    -- Parsing déterministe : ISO AAAA-MM-JJ ou format français JJ/MM/AAAA ou JJ-MM-AAAA.
    ...
    IF v_date IS NULL THEN
      errors := errors || jsonb_build_object(
        'row', idx,
        'numero', v_numero,
        'motif', format('Date invalide (%s) — formats acceptés : JJ/MM/AAAA, JJ-MM-AAAA ou AAAA-MM-JJ', COALESCE(s_date, 'vide'))
      );
      CONTINUE;
    END IF;
