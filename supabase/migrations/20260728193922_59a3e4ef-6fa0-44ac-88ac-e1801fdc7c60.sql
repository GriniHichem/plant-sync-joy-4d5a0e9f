...
CREATE OR REPLACE FUNCTION public.reception_actor_label()
RETURNS text
LANGUAGE sql
STABLE
SECURITY DEFINER
...
REVOKE ALL ON FUNCTION public.reception_actor_label() FROM public, anon;
GRANT EXECUTE ON FUNCTION public.reception_actor_label() TO authenticated;
