-- SUJET : Réception F&L – Retour de l'abattement en kg dans les KPIs qualitatifs
-- Ajout de la colonne total_abat_kg à la fonction get_reception_qualitative_kpis
